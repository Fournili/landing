  ...
  return (
    ...
    >
      <div className="w-[661px] flex flex-col items-center justify-start gap-[24px] max-w-full" dir="rtl">
        <h1 className="m-0 self-stretch relative text-inherit leading-[58px] font-medium font-inherit mq1025:text-19xl mq1025:leading-[46px] mq450:text-10xl mq450:leading-[35px] text-wrap-fr " >
          {t('Facts.Leave the mess in the kitchen')}
        </h1>
        <h1 className="m-0 w-[308px] relative text-21xl leading-[120%] font-medium font-inherit text-primary-300 text-center inline-block mq1025:text-13xl mq1025:leading-[38px] mq450:text-5xl mq450:leading-[29px]" style={{ whiteSpace: isFrench ? 'nowrap' : 'normal'}}>
